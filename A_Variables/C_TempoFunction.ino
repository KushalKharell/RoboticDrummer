...
//For each Fun_called, you can also see the update of the values on the Serial Monitor. From there I can see that everything is updating correctly
    ...
    //updating tempo
    delay_val_4 = (60000/Tempo)-timeToRunLCD; //subtracting time for LCD_Menu() to run to get accurate tempo //try changing 60000 to 37500 -> x*75 = 500-> 37500
    delay_val6_8 = (20040/Tempo)-timeToRunLCD; //subtracting time for LCD_Menu() to run to get accurate tempo //try changing to 12525 -> x*12525 = 167-> 12525
